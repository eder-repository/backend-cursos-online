...
// const URL_CLIENT = "https://facci-cursos-uleam.netlify.app/#";
//
const URL_CLIENT = "http://localhost:3000/#";

// const URL_CLIENT = "https://pedantic-northcutt-914935.netlify.app";

function register(req, resp) {
  const user = new User();

  const { email, password, repeatPassword, name, lastname, birthday, role } =
    req.body;
